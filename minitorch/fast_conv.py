...
def _tensor_conv1d(
    ...
    for b in range(batch_):  # iterate over batches
        for oc in range(out_channels):  # iterate over output channesl
            for ow in range(out_width):  # iterate over output width
                out_value = 0.0
                for ic in range(in_channels):  # iterate over input channels
                    for k in range(kw):  # iterate over kernel width
...
def _tensor_conv2d(
    ...
    for b in range(batch_):
        for oc in range(out_channels):
            for h_out in range(out_shape[2]):  # iterate over output height
                for w_out in range(out_shape[3]):  # iterate over output width
                    out_value = 0.0

                    for ic in range(in_channels):  # iterate over input channels
                        for kh_ in range(kh):  # Iterate over kernal height
                            for kw_ in range(kw):  # Iterate over kernel weidth
